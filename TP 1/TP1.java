...
public class TP1 {
    ...
    private static LinkedList <Pengunjung> daftarKeluar = new LinkedList<Pengunjung>(); // Menyimpan pengunjung di daftar keluah
                    ...
                    for (int i = wahana.size() - 1; i >= 0; i--) {  // i untuk indeks wahana
                        for (int j = 0; j <= maksUang; j++) {       // j untuk kemungkinan semua nominal uang
                            for (int k = 0; k < 3; k++) {           // parity 0 untuk genap, 1 untuk ganjil, 2 jika belom pernah mengambil
                                ...
                                // Kasus 2: naik wahana ke-i (Syarat: parity nya sesuai dan uang mencukupi)
    ...
    // Fungsi rekursif secara backtrack untuk mencari wahana yang diambil untuk perintah O
